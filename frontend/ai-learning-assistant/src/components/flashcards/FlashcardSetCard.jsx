...
const FlashcardSetCard = ({ flashcardSet }) => {
  ...
  return (
    <div
      className="group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl cursor-pointer
                    p-6 hover:border-emerald-300 hover:shadow-lg hover:shadow-emerald-500/10 transition-all duration-300
      ...
      <div className="mt-6 pt-4 border-t border-slate-100">
        <button
          className="group/btn relative w-full h-11 bg-linear-to-r from-emerald-50 to-teal-100
                     hover:from-emerald-600 hover:to-teal-600 rounded-xl text-sm font-semibold text-emerald-700
                     hover:text-white transition-all duration-200 active:scale-95 overflow-hidden"
          onClick={(e) => {
            e.stopPropagation();
            handleStudyNow();
          }}
