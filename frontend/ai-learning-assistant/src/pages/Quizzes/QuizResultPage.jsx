    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="mb-6">
        <Link
          ...
          className="group inline-flex items-center gap-2 text-sm 
                     font-medium text-slate-600 hover:text-emerald-600 transition-colors duration-200"
        >
          <ArrowLeft
      ...
      >
        <div className="text-center space-y-6">
          <div
            className="inline-flex items-center justify-center w-15 h-15 bg-linear-to-br from-emerald-100 to-teal-100
                          shadow-lg shadow-emerald-500/25 rounded-2xl"
          >
          ...
          <div>
            ...
            <div
              className={`inline-block text-5xl font-bold bg-linear-to-r
                        ${getScoreColor(score)} text-transparent bg-clip-text mb-2`}
            >
              {score}%
            </div>
          ...
          <div className="flex items-center justify-center gap-4 pt-4">
            <div
              className="flex items-center gap-2 justify-center px-4 py-2 bg-slate-50 border
            ...
            <div
              className="flex items-center gap-2 justify-center px-4 py-2 bg-emerald-50 border
            ...
            <div
              className="flex items-center gap-2 justify-center px-4 py-2 bg-rose-50 border
                            border-rose-200 rounded-xl"
            >
            ...
            >
              <div className="flex items-start gap-4 justify-between mb-3">
                <div className="flex-1">
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-50 border border-slate-200 rounded-lg mb-2">
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          {isCorrectOption && (
                            <span
                              className="inline-flex items-center gap-1 px-2 py-1 bg-emerald-100 border border-emerald-300 rounded-lg
                          ...
                          {isWrongAnswer && (
                            <span
                              className="inline-flex items-center gap-1 px-2 py-1 bg-rose-50 border border-rose-200 rounded-lg
      ...
      <div className="mt-8 flex justify-center">
        <Link to={`/documents/${documentId}`}>
          <button
            className="group relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600
                             hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200
                             shadow-lg shadow-emerald-500/25 active:scale-95 overflow-hidden"
          >
